...
vi.mock("@/lib/trpc", () => ({ trpc: { storefront: { bundleDetail: { useQuery: () => ({ isLoading: false, data: { creator: { displayName: "Badar", accentColor: "#2255cc" }, bundle: { name: "Launch Kit", price: "39.00", description: "Everything to start" }, items: [{ products: { id: 1, name: "VoiceDelta", price: "20.00" } }, { products: { id: 2, name: "Templates", price: "30.00" } }] } }) } } } }));
